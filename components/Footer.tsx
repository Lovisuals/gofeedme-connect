        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li><Link href="/search" className="hover:text-primary transition-colors">Browse Pools</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Report a Problem</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="p-2 bg-gray-50 rounded-full hover:bg-gray-100 transition-colors"><Twitter className="w-5 h-5 text-gray-600" /></a>
              <a href="#" className="p-2 bg-gray-50 rounded-full hover:bg-gray-100 transition-colors"><Instagram className="w-5 h-5 text-gray-600" /></a>
              <a href="#" className="p-2 bg-gray-50 rounded-full hover:bg-gray-100 transition-colors"><Facebook className="w-5 h-5 text-gray-600" /></a>
            </div>
          </div>
        </div>
